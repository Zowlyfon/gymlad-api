...
namespace GymLad
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = "Host=" + strConn[3] + ";Port=" + strConn[4] + ";Database=" + strConn[5] + ";Password=" + strConn[2] + ";uid=" + strConn[1] + ";sslmode=Require;Trust Server Certificate=true;";
